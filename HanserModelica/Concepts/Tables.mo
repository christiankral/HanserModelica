...
model Tables "Application of tables"
  ...
  Modelica.Electrical.Analog.Basic.VariableResistor variableResistor annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={20,20})));
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable(table=[0,10; 1,10; 1,20; 2,20; 3,10; 4,10])             annotation (Placement(transformation(extent={{70,10},{50,30}})));
initial equation
  inductor.i = 0;
equation
  ...
  connect(combiTimeTable.y[1], variableResistor.R) annotation (Line(points={{49,20},{32,20}}, color={0,0,127}));
