...
model IMC_Transformer "Induction machine with squirrel cage starting with transformer"
  ...
  parameter Modelica.Units.SI.Time tStart2=2.0
  ...
  Modelica.Electrical.QuasiStatic.Polyphase.Sources.VoltageSource sineVoltageQS(
    final m=m,
    f=fsNominal,
    V=fill(VsNominal/sqrt(3), m)) annotation (Placement(transformation(origin={
            -70,80}, extent={{10,10},{-10,-10}})));
  ...
  Modelica.Electrical.QuasiStatic.SinglePhase.Basic.Ground ground2QS
    annotation (Placement(transformation(
        origin={20,50},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  ...
  Modelica.Electrical.Polyphase.Sources.SineVoltage sineVoltage(
    final m=m,
    f=fill(fsNominal, m),
    V=fill(sqrt(2/3)*VsNominal, m)) annotation (Placement(transformation(origin
          ={-70,-20}, extent={{10,10},{-10,-10}})));
  ...
  Modelica.Electrical.Polyphase.Ideal.IdealCommutingSwitch idealCommutingSwitch(
    final m=m,
    Ron=fill(1e-5, m),
    Goff=fill(50E-5, m)) annotation (Placement(transformation(extent={{60,-10},
            {40,-30}}, rotation=0)));
...
equation
  ...
  connect(booleanStep2QS.y, idealCommutingSwitchQS.control) annotation (Line(points={{-39,20},{-10,20},{-10,40},{50,40},{50,72}}, color={255,0,255}));
  ...
  connect(transformerQS.plug2, idealCommutingSwitchQS.plug_n1) annotation (Line(points={{30,80},{36,80},{36,75},{40,75}}, color={85,170,255}));
  connect(sineVoltageQS.plug_p, currentRMSSensorQS.plug_p) annotation (Line(points={{-60,80},{-50,80}}, color={85,170,255}));
  connect(booleanStep1QS.y, idealCloserQS.control) annotation (Line(points={{-39,50},{-10,50},{-10,73}}, color={255,0,255}));
  ...
  connect(booleanStep2.y,idealCommutingSwitch. control) annotation (Line(
      points={{-39,-80},{-10,-80},{-10,-60},{50,-60},{50,-28}},
                               color={255,0,255}));
  ...
  connect(transformer.plug2,idealCommutingSwitch. plug_n1) annotation (Line(points={{30,-20},{36,-20},{36,-25},{40,-25}}, color={0,0,255}));
  ...
  connect(booleanStep1.y,idealCloser. control) annotation (Line(
      points={{-39,-50},{-10,-50},{-10,-27},{-10,-27}},
                                 color={255,0,255}));
