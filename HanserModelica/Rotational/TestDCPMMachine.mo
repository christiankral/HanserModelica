...
model TestDCPMMachine "Test model of DCPMMachine"
  ...
  Modelica.Electrical.Analog.Sources.RampVoltage constantVoltage(V=220,startTime=0.2,duration=0.4) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-50,30})));
equation
  ...
  connect(constantVoltage.n, machine.pin_an) annotation (Line(points={{-40,30},{-30,30},{-30,10.2},{-44,10.2}},
                                                                                                            color={0,0,255}));
  connect(machine.pin_an, ground.p) annotation (Line(points={{-44,10.2},{-30,10.2},{-30,30},{-10,30}},
                                                                                                   color={0,0,255}));
  connect(constantVoltage.p, machine.pin_ap) annotation (Line(points={{-60,30},{-70,30},{-70,10},{-56,10}}, color={0,0,255}));
