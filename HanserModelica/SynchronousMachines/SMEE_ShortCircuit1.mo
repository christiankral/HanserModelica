...
model SMEE_ShortCircuit1 "Single-phase short-circuit of electrical excited synchronous machine "
...
<p>
This example investigates a single-phase short-circuit of an electrical excited synchronous machine. 
