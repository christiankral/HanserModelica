...
model LongRod "Long rod consisting of n short rods"
  ...
  parameter Modelica.SIunits.HeatCapacity C = 1500 "Heat capacity of long rod element";
  parameter Modelica.SIunits.ThermalResistance R = 0.08 "Heat resistance of long rod element";
  parameter Modelica.SIunits.Temperature T0=293.15 "Initial temperature of long rod element";
  Modelica.SIunits.Temperature T[n] = shortRod.heatCapacitor.T "Heat capacitor temperatures";
